        ...
        <div className="installation-screen modal-wrapper active">
            <div className="modal-content">
                ...
                <div className="modal-body">
                    ...
                    <button className={`btn btn-primary ${percentage === 100 ? 'complete' : 'inactive'}`}><a href={percentage === 100 ? tutormate.site_url : '#'} target={percentage === 100 ? '_blank' : '_self'}>{__('View Your Site', 'tutormate')}</a></button>
                </div>
            </div>
        </div>
    );
