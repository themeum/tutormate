...
const Installation = ({status, percentage, plugins, pluginStatus, pluginResponse}) => {
                    ...
                    <div className="plugin-status">
                            <div className="plugin-item">
                                ...
                                {  'success' === pluginStatus ?
                                    ...
                                    <div className='title'>{pluginResponse.message ? pluginResponse.message : __( 'Loading...', 'tutormate' )}</div>
                                </Fragment>
