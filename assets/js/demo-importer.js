...
function App() {
  ...
  var _useState5 = useState(false),
      ...
      importCompleted = _useState6[0],
      setImportCompleted = _useState6[1];
  ...
  var _useState19 = useState(''),
      ...
      demoNotice = _useState20[0],
      setDemoNotice = _useState20[1];
  ...
  var _useState23 = useState({}),
      ...
      pluginInfo = _useState24[0],
      setPluginInfo = _useState24[1];

  var _useState25 = useState([]),
      _useState26 = _slicedToArray(_useState25, 2),
      plugins = _useState26[0],
      setPlugins = _useState26[1];

  useEffect(function () {
    if (importCompleted) {
      bulkImageDownload();
    }
  }, [importCompleted]); // Fetch the attachment list from server

  var fetchAttachments = /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 3;
              return fetch(tutormate.ajax_url + '?action=tutormate_attachments&security=' + security);
    ...
    return function fetchAttachments() {
      return _ref.apply(this, arguments);
    };
  }();

  var bulkImageDownload = /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee2() {
      var promises, security, base_url, res, update_meta_task, rows;
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              security = tutormate.ajax_nonce;
              base_url = tutormate.ajax_url + '?action=tutormate_download_attachment&security=' + security;
              _context2.next = 5;
            ...
            case 5:
              ...
              if (res.success) {
                ...
                update_meta_task = fetch(base_url + '&update_meta=true');
                promises.push(update_meta_task);
                rows = res.data;
                rows.forEach(function (row) {
                  if (row.data.post_type === 'attachment') {
                    var target_url = "".concat(base_url, "&media_id=").concat(row.data.post_id);
                    var async_task = fetch(target_url);
    ...
    return function bulkImageDownload() {
  ...
  var setBuilderPlugins = function setBuilderPlugins(plugins) {
    useEffect(function () {
      setPlugins(plugins);
    }, []);
  };
  ...
  var pluginInstall = /*#__PURE__*/function () {
    var _ref3 = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee3(selected, builder, plugins) {
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              ...
              plugins.forEach(function (_ref4) {
                var title = _ref4.title,
                    state = _ref4.state;
                setPluginInfo(function (prevInfo) {
                  return _objectSpread(_objectSpread({}, prevInfo), {}, _defineProperty({}, title, {
                    title: title,
              ...
              _loop = /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _loop(i) {
                var currentPluginName, currentPlugin, res, responseData;
                return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _loop$(_context3) {
                  while (1) {
                    switch (_context3.prev = _context3.next) {
                      case 0:
                        currentPluginName = selectedPlugins[i];
                        currentPlugin = plugins.find(function (plugin) {
                          return plugin.slug === currentPluginName;
                        });
                        setPluginInfo(function (prevInfo) {
                          return _objectSpread(_objectSpread({}, prevInfo), {}, _defineProperty({}, currentPlugin.title, {
  ...
  var installationAjax = /*#__PURE__*/function () {
    var _ref5 = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee4(data) {
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee4$(_context5) {
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              return _context5.abrupt("return", fetch(tutormate.ajax_url, {
                method: 'POST',
                headers: {
    ...
    request.onreadystatechange = function () {
      if (this.readyState == 4 && this.status == 200) {
        ...
        if ('undefined' !== response.status && 'newAJAX' === response.status) {
          ...
          doAjax(customizerData); // setPercentage(100);
  ...
  var PopupModal = function PopupModal(_ref6) {
    var selectedIndex = _ref6.selectedIndex;
    ...
    }, __('Cancel', 'tutormate')), /*#__PURE__*/React.createElement("button", {
  ...
  var ListItems = function ListItems(_ref7) {
    var listItems = _ref7.listItems;
    return /*#__PURE__*/React.createElement("ul", {
      ...
      }, /*#__PURE__*/React.createElement("span", null, __('Import', 'tutormate'))))));
...
var Installation = function Installation(_ref) {
  ...
  var renderLoader = function renderLoader() {
    return Object.keys(pluginInfo).map(function (pluginName) {
      var plugin = pluginInfo[pluginName];
      var pluginState = plugin.pluginState,
          responseStatus = plugin.responseStatus,
          title = plugin.title;
      ...
      if (pluginState === 'active') {
        ...
        if (responseStatus === 'initial') {
          ...
          return /*#__PURE__*/React.createElement("div", {
            ...
            "class": "dashicons dashicons-no-alt plugin-not-installed"
          }), /*#__PURE__*/React.createElement("div", {
            className: "title"
          }, title ? title : __('Loading...', 'tutormate')));
        }
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "modal-content"
  }, percentage === 100 ? /*#__PURE__*/React.createElement("div", {
    className: "heading"
  }, /*#__PURE__*/React.createElement("div", {
    ...
    key: "demo-importer"
  }, percentage === 100 ? /*#__PURE__*/React.createElement("svg", {
    id: "svg-circle",
    style: {
      marginRight: '-2px'
    }
  ...
  }, "Demo Content"))), /*#__PURE__*/React.createElement("button", {
    className: "btn btn-primary ".concat(percentage === 100 ? 'complete' : 'inactive')
...
__webpack_require__(/*! /Users/harun/Sites/wp-tutor-test/wp-content/plugins/tutormate/react/src/demo-importer.js */"./react/src/demo-importer.js");
module.exports = __webpack_require__(/*! /Users/harun/Sites/wp-tutor-test/wp-content/plugins/tutormate/react/src/sass/app.scss */"./react/src/sass/app.scss");
